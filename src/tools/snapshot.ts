...
import { ClickTool, DragTool, HoverTool, SelectOptionTool, SnapshotTool, TypeTool } from "../types/tools.js";
  ...
  handle: async (context: Context, params) => {
    ...
    return {
      content: [
        {
          type: "text",
          text: `Dragged "${validatedParams.sourceSelector}" to "${validatedParams.targetSelector}"`,
        },
        ...snapshot.content,
      ],
    };
